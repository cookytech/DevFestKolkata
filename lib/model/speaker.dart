...
class Speaker {
  ...
  const Speaker.dummy()
      : name = 'Raveesh Agarwal',
        ...
        about =
            'Entrepreneur, software craftsman and technology enthusiast, I have established, led, worked with and consulted teams and growing corporations. I continue to solve problems and grow with my projects, partnerships and endeavours.',
        imageURI =
